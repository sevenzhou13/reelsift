...
- 素材卡片支持收藏和 1-5 级评分，素材库页可按收藏、评分和关键词筛选
- 详情页支持摘要编辑、标签追加、MY NOTE、口播重识别、前后切换、删除、进入粗剪
- 粗剪页支持片段命名、预览、修边、删除确认和按名称导出
- 相似素材对比页支持推荐最佳项和一键保留
- 素材导出和粗剪片段导出支持选择本地导出目录
...
- [~] Day 6: 多选导出、对比页、项目树、回收站、收藏评分、粗剪页已可用，仍在收尾交互
