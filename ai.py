...
- 如果口播明确说明了事件主题、拍摄目的、人物正在做什么或创作者想表达的内容，summary 应优先吸收这些信息，再用关键帧校验主体和场景。
- actions、tags 可以参考口播补充说话内容、事件主题和可检索词。
- 如果口播与画面有轻微冲突，以画面为准；如果口播能明确说明事件主题，要让 summary 更贴近事件，而不是只描述表层画面。
...
- summary 字段：一句话客观描述，尽量 10-16 个字，优先写成“谁在什么场景做什么”的筛片用语。
  ...
  如果有有效口播，summary 可以写出口播透露的事件，例如“女生说跳舞后很累”“两人聊拍摄体验”，但仍要保持筛片用语，不要写成长句。
